...
csv_file="csv/create_stitched_Rst.csv"
...
for Rst in "${Rst_values[@]}"; do
  ...
  ./bin/main -f dummy -k 100 -L 150 -R 42 -Rst "$Rst" -a 1.2 -v stitched -x create | while read -r K L R Rstitched a_val UserTime ElapsedTime; do
