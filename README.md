...
- Ο Αργύριος Λαζαρίδης (1115202100083) ασχολήθηκε με την αρχική σχεδίαση όλων των modules και υλοποίησε τα τα περισσότερα unit test (εκτος αυτων που αναφέρονται απο τα άλλα μέλη) οπως και των αλγορίθμων του knn.hpp για τα οποία χρειάστηκε η λύση τους στο χαρτί προκειμενου να γινει επαλήθευση των αποτελεσμάτων. Εκτος αυτου υλοποίησε τις αρχικες μορφες των συναρτήσεων vec_to_graph και make_vec.
