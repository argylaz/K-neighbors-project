...
csv_file="csv/create_filtered_R.csv"
...
for R in "${R_values[@]}"; do
  ...
  ./bin/main -f dummy -k 100 -L 150 -R "$R" -a 1.2 -v filtered -x create | while read -r K L R Rstitched a_val UserTime ElapsedTime; do
